...
function main(){
  ...
  checks.push(check("external_fetch","External public source",fetchStatus.realFetch?"ok":"warn",fetchStatus.mode||"unknown",fetchStatus.realFetch?"تم الجلب من مصدر خارجي مضبوط":"لا يوجد دليل على جلب خارجي؛ قد تكون البيانات من الملفات الحالية فقط",fetchStatus.realFetch?"متابعة":"اضبط EGX_MARKET_JSON_URL أو أضف fetcher حقيقي"));
