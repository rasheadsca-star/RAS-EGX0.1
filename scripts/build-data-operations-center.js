...
function main(){
  const source=read("data/source-health.json",{}), price=read("data/price-reconciliation-report.json",{summary:{}}), hist=read("data/history-backfill-plan.json",{}), ranking=read("data/final-opportunity-ranking.json",{summary:{}}), alerts=read("data/alert-decision-center.json",{summary:{}}), reg=read("data/app-regression-report.json",{});
  const checks=[];
